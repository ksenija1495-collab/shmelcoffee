...
- Hario Switch (ОБЯЗАТЕЛЬНО указывать клапан — это не V60):
  · Клапан ЗАКРЫТ: блум, долив воды, вся иммерсия.
  · Клапан ОТКРЫТ: только drawdown (слив), после настаивания.
  · Референс (иммерсия): 15 г / 250 мл · 92 °C · помол средний · блум 40 мл / 0:30 · долить до 250 · иммерсия с закрытым клапаном 1:15–1:30 · открыть клапан · слив ~1:00–1:30.
  · Запрещено: схема «1-й пролив 60 мл, 2-й 100 мл…» без строк про клапан — это V60, не Switch.
  · Если в дневнике лот заходил на V60 — для Switch дай адаптированный рецепт выше, а не копируй проливы V60.
