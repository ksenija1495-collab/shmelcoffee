...
description: "20 стран specialty и их вкусовые профили: чем Эфиопия отличается от Колумбии, что искать на упаковке и у каких обжарщиков купить в России."
date: 2026-07-30
cluster: "C3"
type: "cluster"
...
В приложении Shmelco есть [**карта открытий**](/countries): 20 стран, которые стоит пробовать в specialty. Страна «открывается», когда вы добавляете **чашку в дневник** или **зерно на полку** с этой страной — прогресс виден в [личном кабинете](/account?tab=disco).
...
> Ассортимент меняется — ссылки ведут на каталоги и актуальные лоты на момент публикации. Если лот закончился, ищите ту же страну в фильтре «single origin» у обжарщика.
...
- **Где попробовать в РФ** — обжарщики и ссылки
...
20 стран — не весь мир кофе, но **достаточно**, чтобы понять главные «вкусовые континенты». Дальше — ваши открытия в чашке.
